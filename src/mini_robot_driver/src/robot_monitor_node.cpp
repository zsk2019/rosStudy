#include "mini_robot_driver/robot_monitor_node.hpp"
...
void RobotMonitorNode::monitor_battery(float battery) const {
  if (battery >= 30.0F) {
...
int main(int argc, char* argv[]) {
  ...
  rclcpp::spin(std::make_shared<Mrb::RobotMonitorNode>());
  rclcpp::shutdown();
  return 0;
}
